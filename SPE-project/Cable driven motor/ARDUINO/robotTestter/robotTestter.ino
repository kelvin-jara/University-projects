...
double kp=1.1*22.2707628694451 ,ki=2.0*59.2428963251724,kd=1.0*0.539873470177468, N=17.4572555042356; 
...
void loop(){
  input =  +(float) encodercount_A*(10.0/209.0)*10.0;
  input2 =  -(float) encodercount_B*(10.0/209.0)*10.0;
  input3 =  -(float) encodercount_C*(10.0/209.0)*10.0;
  input4 =  +(float) encodercount_D*(10.0/209.0)*10.0;
  ...
  encoder0Pos3 = position_C;
  encoder0Pos4 = position_D;
  input = encoder0Pos;
  input2 = encoder0Pos2;
  input3 = encoder0Pos3;
  input4 = encoder0Pos4;
